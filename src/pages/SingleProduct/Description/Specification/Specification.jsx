...
const Specification = () => {
	return (
		<section className={classes.specification}>
			<ul>
				<li><img src={os} alt="" />Operating System IOS 12</li>
				<li><img src={camera} alt="" />Camera 12+12+16MP</li>
				<li><img src={processor} alt="" />Processor 16</li>
				<li><img src={battery} alt="" />Battery 2500mAh</li>
				<li><img src={memory} alt="" />Memory 4gb</li>
				<li><img src={display} alt="" />Display 5 inches</li>
				<li><img src={storage} alt="" />Storage 128gb</li>
			</ul>
		</section>
	);
};
